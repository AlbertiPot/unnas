...
if __name__ == '__main__':
    ...
    parser.add_argument('--datapath', default='/data/gbc/workspace/rdarts/data/cifar/cifar10', metavar='DIR', help='path to the dataset')
    ...
    #--------------------------------------------------------------------------
    net = model_loader.load(args.dataset, args.model_file)
    ...
    #     torchvision.datasets.CIFAR10(root=args.datapath, train=True, download=False)
